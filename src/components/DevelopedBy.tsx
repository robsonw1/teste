  ...
  return (
    <div className={`mt-6 text-center text-xs text-muted-foreground ${className || ''}`}>
      ...
      >
        ...
        >
          <span className="text-[13px] md:text-sm font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-600 dark:from-white" style={{WebkitTextFillColor: 'transparent'}}>ÆZap</span>
        </span>
