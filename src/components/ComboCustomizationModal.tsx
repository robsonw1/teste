            ...
            {pizzaType1 === 'inteira' ? (
              <div className="flex items-center gap-2">
                <div className="flex-1">
                  <Select value={selectedPizza1} onValueChange={(v) => { setSelectedPizza1(v); /* after choosing inteira, scroll to next step (second pizza for família) */ setTimeout(() => scrollToSection(isComboFamilia ? secondPizzaRef.current : bordaRef.current), 200); }}>
                    <SelectTrigger>
              ...
              <div ref={sabor2Ref} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Select value={pizza1SaborA} onValueChange={(v) => { setPizza1SaborA(v); /* after selecting sabor1, scroll to sabor2 on mobile */ setTimeout(() => scrollToSection((sabor2Ref.current as HTMLElement)), 180); }}>
                    <SelectTrigger>
                ...
                <div>
                  ...
                  <Select value={pizza1SaborB} onValueChange={(v) => { setPizza1SaborB(v); /* after selecting sabor2, scroll to borda or second pizza if família */ setTimeout(() => scrollToSection(isComboFamilia ? secondPizzaRef.current : bordaRef.current), 180); }}>
                    <SelectTrigger>
          ...
          <>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                {pizzaType2 === 'inteira' ? (
                  <div>
                    <Select value={selectedPizza2} onValueChange={(v) => { setSelectedPizza2(v); setTimeout(() => scrollToSection(bordaRef.current), 200); }}>
                      <SelectTrigger>
                  ...
                  <div ref={adicionaisRef} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <Label className="text-sm font-medium">Sabor 1</Label>
                      <Select value={pizza2SaborA} onValueChange={(v) => { setPizza2SaborA(v); setTimeout(() => scrollToSection((adicionaisRef.current as HTMLElement)), 180); }}>
                        <SelectTrigger>
                          <SelectValue placeholder="Selecione o primeiro sabor" />
                        </SelectTrigger>
                        <SelectContent>
                    ...
                    <div>
                      <Label className="text-sm font-medium">Sabor 2</Label>
                      <Select value={pizza2SaborB} onValueChange={(v) => { setPizza2SaborB(v); setTimeout(() => scrollToSection(bordaRef.current), 180); }}>
                        <SelectTrigger>
                          <SelectValue placeholder="Selecione o segundo sabor" />
                        </SelectTrigger>
                        <SelectContent>
