              ...
              <div className="space-y-3 max-h-96 overflow-y-auto">
                {pizzas.map((pizza) => (
                  <Card 
                    ...
                    onClick={() => { setSelectedFlavor1(pizza); setTimeout(() => scrollToSection(sabor2Ref.current), 160); }}
                  >
            ...
            <div ref={sabor2Ref} className="space-y-3 max-h-96 overflow-y-auto">
              {pizzas
                ...
                <Card 
                  ...
                  onClick={() => { setSelectedFlavor2(pizza); setTimeout(() => scrollToSection(resumoRef.current), 160); }}
                >
                  <CardContent className="p-4">
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
